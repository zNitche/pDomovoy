...
#define PD_ACCELERATION_CHANGE_TRIGGER_FACTOR 0.3
#define PD_ACCELERATION_READINGS_COUNT 15
#define PD_ACCELERATION_READINGS_DELAY 100

#define PD_ACCELERATION_INITIAL_READINGS_COUNT 15
#define PD_ACCELERATION_INITIAL_READINGS_DELAY 200
